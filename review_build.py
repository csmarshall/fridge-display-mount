...
{fig(root, "cost_sturdiness.svg", "Cost vs sturdiness", "Gauge by magnet count, live prices, with the feels-rigid and bump-margin cutoffs drawn and dominated rows greyed. The chosen cell is the corner of the viable region.")}
...
<p class="blurb">Design 1's plate at 0.187 in HRPO, with four extra holes in two rows near the
bottom edge. Phase 1 is the hook with eight body magnets. If that proves too lively in use, phase 2 bolts two
...
{table([
    ("Plate", f"{plate3['flat']['width_mm']:.0f} x {plate3['flat']['height_mm']:.2f} mm, {h3.plate_t / 25.4:.3f} in, {len(plate3['holes'])} holes", "design 1's hole set plus four strut bolts"),
...
{ask(3, [
    "The plate went to 0.119 in for a week and back to 0.187 in on the live gauge sweep ($12.70 for 4x the stiffness). Would you have stayed thin, and is the nut stack on a 10 +/-2.5 mm stud through 4.75 mm of plate a real concern?",
