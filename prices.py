...
P: dict[str, Price] = {p.key: p for p in (
    ...
    Price("m6_fender", "M6 x 18 x 1.7 A2-70 fender washer, 8 pcs", 1.6, "8",
          "BoltsandNuts M6X18FWA2", "2026-09-08",
          "$0.20/pc; OD 18.1, ID 6.62, 1.7 thick. McMaster VERIFIED alternate: 91116A150, 18-8, 6.4 x 18 x 1.4-1.8, pack of 50, $14.70"),
